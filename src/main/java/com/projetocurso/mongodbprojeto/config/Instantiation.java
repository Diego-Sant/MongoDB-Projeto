...
import com.projetocurso.mongodbprojeto.dto.AuthorDTO;
import com.projetocurso.mongodbprojeto.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagem :D", sdf.parse("21/03/2018"), new AuthorDTO(alex));
